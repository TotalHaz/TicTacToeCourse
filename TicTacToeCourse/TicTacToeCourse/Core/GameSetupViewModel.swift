...
final class GameSetupViewModel: ObservableObject    {
    ...
    private extension GameSetupViewModel {
        ...
        func updateFirstTurn(with selectedFirstTurn: FirstTurn) {
