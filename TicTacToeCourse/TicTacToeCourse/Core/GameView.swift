...
private extension GameView {
    var playerStatsView: some View {
        ...
        .animation(.easeInOut(duration: GameConstants.playerSwapAnimationDuration), value:
                    viewModel.currentPlayer.cellSymbol)
